...
class PharmaciesControllerTest < ActionController::TestCase
  ...
  test "should create pharmacy" do
    assert_difference('Pharmacy.count') do
      post :create, pharmacy: { adress: @pharmacy.adress, nearest_metro: @pharmacy.nearest_metro, number: @pharmacy.number }
    end
  ...
  test "should update pharmacy" do
    patch :update, id: @pharmacy, pharmacy: { adress: @pharmacy.adress, nearest_metro: @pharmacy.nearest_metro, number: @pharmacy.number }
    assert_redirected_to pharmacy_path(assigns(:pharmacy))
  end
